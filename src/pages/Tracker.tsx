      ...
      <main className="px-4 py-6 space-y-6 max-w-md mx-auto">
        <div className="space-y-4">
          <div className="text-center mb-2">
            <h2 className="text-2xl font-bold text-foreground mb-1">Tracker</h2>
            <p className="text-muted-foreground">Track Your Daily Oil Use</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <Button
              ...
              onClick={() => alert("Log Use feature coming soon!")}
            >
